...
We are using Planning Poker in order to estimate stories in each cycle of development. This method is known to avoid anchoring and will produce more accurate, less optimistic story point estimations\footnote{\tt{http://en.wikipedia.org/wiki/Planning\_poker\#Planning\_poker\_benefits}}. This technique takes some time to get used to because initially the story points bared little meaning to us. As the tasks got more concrete and we got used to comparing stories against numbers in the Fibonacci sequence the poker game proved to be a very efficient method. 
