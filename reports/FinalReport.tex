...
We could have wasted a lot of time hand coding these components\footnot{NIH\todoo[inline]{add refrence}} but it was faster to integrate and configure existing components.
