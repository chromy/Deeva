...
In addition, it provides a lot more functionalities than jdb such as setting a conditional breakpoints and having an user friendly graphic user interface.
