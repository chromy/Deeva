...
For example although the class is now taught in Java () \todo{Do we need this bracket?}. it has previously been taught in Kenya\footnote{} a language which acts as an imperative stepping stone to Java by allowing functions to exist outside of objects.
