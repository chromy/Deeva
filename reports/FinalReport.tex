...
- We have limited desktop experience GUI
- Lots of custom code for the state UI
- Java GUIs suck

In contrast we had a lot of web development experience, the web is 
Moreover framing the


- A lot of Web experience
- Web service promotes clear boundary between interface and backend allowing us to more effectively work on the project (people can work on front and back end simultaneously)
- Opens up better technologies
- Exiting applications
- Faster development
- lots of
- Opptuiting for learning
...
Over the period we worked on this project Github had a few hours of down time but this was easily less than the time it would have taken us to setup and mantain our own source control server.
...
The major downside was since Travis has to install all the dependencies each time running the tests could take up to ten  
