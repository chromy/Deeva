...
\caption{JSwat debugger example}
\end{figure}
...
\caption{Eclipse debugger example}
\end{figure}
...
\caption{IntelliJ debugger example}
\end{figure}
...
However it does has this much better display of state which we are interested in.
