...
In addition, it provides a lot more functionalities than jdb sush as setting a conditional breakpoints and having an user friendly graphic user interface.
