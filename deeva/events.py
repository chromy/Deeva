...
class DeevaEventDispatcher(object):
    ...
    def stack_heap_objects(self, stack_data, heap_data):
    ...
    def absent_information(self, class_name):
...
class DeevaAbsentInformationEvent(DeevaEvent):
    def __init__(self, class_name):
        self.name = 'absent_information'
        self.class_name = class_name

    def format_event(self):
        messages = []
        messages.append("event: absent_information\n")
